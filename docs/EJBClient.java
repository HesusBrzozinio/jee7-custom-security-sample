...
public class EJBClient {
	...
	public static void main(final String[] args) {
		final BookServiceRemote bean = doLookup();
		if (bean != null) {
			System.out.println(bean.getBooks()); // 4. Call business logic
		}
	}
	...
	private static BookServiceRemote doLookup() {
		...
		try {
			...
			// 2. Lookup and cast
			bean = (BookServiceRemote) context
					.lookup("/sampleapp-ear/sampleapp-core-0.1.0-SNAPSHOT/BookServiceBean!service.BookServiceRemote");
